    ...
    useEffect(() => {
        const fetchArticles = async () => {
            try {
                ...
                setArticlesCount(response.date.articlesCount);
                    ...
                    <div className="container-fluid bg-w">
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                <li onClick={() => setSort(1)} className="nav-item">
                                    <a className={`nav-link active ${sort === 1 ? 'text-primary' : 'text-dark'}`} aria-current="page" href="#"><p className="h5">Editors'choice</p></a>
                                </li>
                                <li onClick={() => setSort(2)} class="nav-item">
                                    <a className={`nav-link active ${sort === 2 ? 'text-primary' : 'text-dark'}`} href="#"><p className="h5">Followings</p></a>
                                </li>
                                <li onClick={() => setSort(3)} class="nav-item">
                                    <a className={`nav-link active ${sort === 3 ? 'text-primary' : 'text-dark'}`} href="#"><p className="h5">Hot</p></a>
                                </li>
                            </ul>
                ...
                <div className='aricle col-9'>
                    ...
                    <div >
                        <div className="d-flex justify-content-end">
                            ...
                            <Link to={`/`} onClick={() => setTab(1)}> <i type="button" className={`icon1 bi bi-card-list ${tab === 2 && 'text-black'}`} data-toggle="tooltip" data-placement="bottom" title="Only title"></i></Link>
                            <Link to={`/`} onClick={() => setTab(2)}> <i type="button" className={`icon1 bi bi-newspaper ${tab === 1 && 'text-black'}`} data-placement="bottom" title="With preview contents"></i></Link>
                        </div>
