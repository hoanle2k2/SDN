...
const EditBlog = () => {
    ...
    useEffect(() => {
        ...
        }).then(data => { console.log(data); setTopic(data.data.data) });
    }, [])
                        ...
                        {(formik) => (
                            <Form style={fieldStyle}>
                                ...
                                <div className='my-2 form-control form-control-lg'>
                                    ...
                                    />
                                    <h5><ErrorMessage style={{ color: 'red' }} name="Content" component="div" /></h5>
                                </div>
                                <div className="my-2">
                                    ...
                                    <h5><ErrorMessage style={{ color: 'red' }} name="TopicID" component="div" /></h5>
                                </div>
